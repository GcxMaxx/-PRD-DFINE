...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', '-i', default= "/mnt/data/user/gg/deim/dataset/InsPLAD-det/val", type=str)
    parser.add_argument('--json', '-j', default= "/mnt/data/user/gg/deim/dataset/InsPLAD-det/annotations/instances_val_cat0_16.json", type=str)
