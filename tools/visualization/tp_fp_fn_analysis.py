...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', '-i', default="/mnt/data/user/gg/deim/dataset/IPLID/images/val", type=str)
    parser.add_argument('--label_json', '-l', default="/mnt/data/user/gg/deim/dataset/IPLID/annotations/val.json", type=str)
    parser.add_argument('--pred_json', '-p', default="outputs/df-s-lplid-8-base3001_eval/pred_bbox.json", type=str)
